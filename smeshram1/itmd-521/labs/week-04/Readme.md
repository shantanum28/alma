...
![Python_inferred](images/Python_Inferred.png "Python_inferred")

### Screenshot of the printSchema programmatically in Python

![Python_programmatically](images/Python_Programmatically.png "Python_programmatically")

### Screenshot of the printSchema via DDL in Python

![Python_DDL](images/Python_DDL.png "Python_DDL")
